...
set :application, "grubulate" # this will be used to create the folder structure (see line)
...
set :domain, "chernobyl.webhop.net" #"IP or domain name of production server"
...
set :repository,  "ssh://deploy@gerrithost/grubulate.git"
